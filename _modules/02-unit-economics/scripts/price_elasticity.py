...
def print_target_prices(results, category=None):
    ...
    print(f"\n{'=' * 100}")
    title = "ЦЕЛЕВЫЕ ЦЕНЫ ДЛЯ 2× ОБЪЁМА"
    if category:
        title += f" — {category}"
    print(title)
    print(f"{'=' * 100}\n")
...
def plot_all(results, sku_price_qty, sku_platform_data, output_dir):
    ...
    plt.close()
    print("  01_elasticity_all_skus.png")
    ...
    plt.close()
    print("  02_elasticity_by_category.png")
    ...
    plt.close()
    print("  03_price_vs_qty_top12.png")
    ...
    if multi_price_skus:
        ...
        plt.close()
        print("  04_demand_curves_multi_price.png")
    ...
    plt.close()
    print("  05_price_vs_demand_change.png")
