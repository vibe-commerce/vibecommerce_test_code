...
│
├── MARKETPLACE_PRJ/             # Проект: маркетплейсы (WB, Ozon)
│   ├── README.md
...
│
├── DTC_PRJ/                     # Проект: собственный e-com (D2C)
│   ├── README.md
...
│   └── README.md
│
├── DEMO_PRJ/                    # Демо-проект (финмодели, слайды)
...
### Папки проектов (*_PRJ/)
Каждый проект — отдельная папка с суффиксом `_PRJ`. Внутри обязательно README.md и FACTS.md с ключевыми метриками.
